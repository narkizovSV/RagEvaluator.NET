...
public class NdcgAtKMetric : ITopKMetric
{
    ...
    private static double ComputeDcg(IReadOnlyDictionary<string, double> rankedDocuments, IReadOnlyDictionary<string, int> qrels, int k)
    {
        var rank = 1;
        var dcg = 0d;
